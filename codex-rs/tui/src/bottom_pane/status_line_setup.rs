...
pub(crate) enum StatusLineItem {
    ...
    /// Input tokens split by cache status, plus output tokens.
    TokenUsageBreakdown,
...
impl StatusLineItem {
    ...
    pub(crate) fn description(self) -> &'static str {
        match self {
            ...
            StatusLineItem::TokenUsageBreakdown => {
                "Non-cached input, cached input, output tokens, and server-reported thread cost"
            }
    ...
    pub(crate) fn preview_item(self) -> StatusSurfacePreviewItem {
        match self {
            ...
            StatusLineItem::TokenUsageBreakdown => StatusSurfacePreviewItem::TokenUsageBreakdown,
